                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">WELCOME! <?php echo strtoupper($crow['fullname']); ?> | BOOKED APPOINTMENT</h4>
                                <p class="category"><?php echo date('F d, Y h:i:s');  ?></p>
                            </div>
                            <div class="content">
                                 <iframe src="frame/?user_id=<?php echo $crow['user_id']; ?>" style="width:100%; border:none; height:600px;"></iframe>
