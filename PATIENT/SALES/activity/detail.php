					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="../../ADMIN/includes/<?php echo $crow["image"]; ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="../../ADMIN/includes/<?php echo $crow["image"]; ?>" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="../../ADMIN/includes/<?php echo $crow["image"]; ?>">
